      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="datakost_lk.php">Kost Laki-laki</a>
            <a class="collapse-item" href="datakost_pr.php">Kost Perempuan</a>
          </div>
        </div>
      </li>
            ...
            <div class="col-xl-12 col-lg-11">
              <div class="card shadow mb-4">
                ...
                <table border="1" width="100%">
                    ...
                    $query = "SELECT * FROM kost where jenis_kost='1'"; // Query untuk menampilkan semua data siswa
                    ...
                    while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                        ...
                        echo "<td><a href='delete_kost.php?id_kost=".$data['id_kost']."&read_lk=1'>Hapus</a></td>";
                        echo "</tr>";
                    }
                    ?>
                    </table>
