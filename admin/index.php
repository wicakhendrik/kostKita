...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="datauser.php?data=admin&user=<?php echo $user; ?>">
        ...
        <!-- <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="datauser.php?data=admin">Admin</a>
            <a class="collapse-item" href="datauser.php?data=pemilik">Pemilik Kost</a>
          </div>
        </div> -->
      </li>
            ...
            <div class="col-xl-12 col-lg-11">
              <div class="card shadow mb-4">
                ...
                <div class="card-body text-center">
                  ...
                  <h3>SELAMAT DATANG DI DASHBOARD ADMIN KOST KITA</h3>
                  <h4>Mempermudah mahasiswa mencari kost<br> daerah sekitar Universitas Trunojoyo.</h4>
